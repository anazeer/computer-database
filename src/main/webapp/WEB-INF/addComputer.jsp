						...
						<fieldset>
							<div class="form-group">
								<label for="computerName">Computer name</label> <input
									...
									value="${pname}"> <span id="computerNameError"
									style="color: red;">${vcomputerName}</span>
							</div>
							<div class="form-group">
								<label for="introduced">Introduced date</label> <input
									type="date" class="form-control" id="introduced"
									name="introduced" placeholder="Introduced date (yyyy-mm-dd)"
									value="${pintro}"> <span id="computerIntroError"
									style="color: red;">${vintroduced}</span>
							</div>
							<div class="form-group">
								<label for="discontinued">Discontinued date</label> <input
									...
									value="${pdiscontinued}"> <span
									id="computerDiscontinuedError" style="color: red;">${vdiscontinued}</span>
							</div>
							<div class="form-group">
								...
								</select> <span id="computerError" style="color: red;">${vglobal}</span>
							</div>
						</fieldset>
